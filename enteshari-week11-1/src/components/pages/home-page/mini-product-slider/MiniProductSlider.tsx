import {MiniProductSliderMock} from "@/mocks/MiniProductSliderMock";
                    ...
                    MiniProductSliderMock.map((item,index)=>{
                        return(
                            <SwiperSlide key={index} >
                             <div  style={{backgroundColor:item.bgColor, backgroundImage:`url(${item.imgSrc})`}} className="flex items-center aspect-slider pl-4 lg:pl-12  rounded-[10px] bg-[length:50%]  bg-no-repeat bg-right-bottom">
