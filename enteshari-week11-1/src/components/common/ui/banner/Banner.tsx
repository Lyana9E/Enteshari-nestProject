...
export function Banner({title,subTitle,bgImage , Image}:Props) {
    return (
        <>
            <div style={{backgroundImage: `url(${bgImage})`}} className="grid grid-cols-2 items-center rounded-lg bg-hero-pattern  bg-[#FDC040] bg-opacity-20 bg-cover bg-no-repeat">
                ...
                <ImageView src={Image} className="m-w-[50%]" alt={'banner'} height={717} width={538}/>
            </div>
            <form name="subscription" method="post" action="#" className="flex lg:hidden gap-2.5 items-center justify-between rounded-[30px] mx-auto max-w-[550px] bg-[#F5F5F5] pl-4 sm:pl-5 md:pl-6 mt-4 sm:mt-5 md:mt-6">
                <IconBox icon={'icon-paper-plane'} link={'#'} size={24} />
