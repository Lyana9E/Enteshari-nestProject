        ...
        return (
            <>
                <div className="group border-[1px] border-gray-200 hover:border-green-150 rounded-[10px] hover:shadow-[20px_20px_40px_0_rgba(24,24,24,0.07)] relative p-3 md:p-4 xl:px-5 xl:pb-5 lg:pt-[65px] h-full">
                    ...
                    <ImageView src={sliderItem.imgSrc} className={'m-auto w-full aspect-[3/2] mb-[28px]'} width={210} height={168} alt={'product image'} />
                    <div className="flex flex-col gap-2">
                        <div className="text-gray-500 text-xsmall">{sliderItem.category}</div>
                        <Link href={'./'}>   <h3 className="text-heading-sm text-blue-300 max-h-[50px] overflow-hidden">{sliderItem.title}</h3> </Link>
                    ...
                    <div className="flex items-center justify-between mt-3">
                        <div>
                            ...
                            <span className="text-heading-sm line-through text-gray-500">${sliderItem.price}</span>
                        </div>
