        ...
        return (
            <>
                <div className="group border-[1px] border-gray-200 hover:border-green-150 rounded-[10px] hover:shadow-[20px_20px_40px_0_rgba(24,24,24,0.07)] relative p-3 md:p-4 xl:px-5 xl:pb-5 lg:pt-[65px] h-full">
                    ...
                    <ImageView src={sliderItem.imgSrc} className="m-auto w-full aspect-[3/2] mb-[28px]" width={120} height={120} alt={'product image'} />
                    <div className="flex flex-col gap-2">
                        <div className="text-gray-500 text-xsmall">{sliderItem.category}</div>
                        <h3 className="text-heading-sm text-blue-300 max-h-[50px] overflow-hidden">{sliderItem.title}</h3>
                        <div className="flex gap-4">
                            ...
                            <div className="text-xsmall text-gray-500 font-lato">({sliderItem.rate})</div>
                        </div>
