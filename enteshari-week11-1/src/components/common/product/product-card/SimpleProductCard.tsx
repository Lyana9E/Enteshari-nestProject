    ...
    return (
        <>
            <div
                ...
                {data.attributes.label && <Badge  badge={data.attributes.label} price={data.attributes.price} salePrice={data.attributes.sell_price}/>}
                <div
                ...
                <ImageView src={data.attributes.thumbnail?.data?.attributes.url} className={'m-auto w-full aspect-[3/2] mb-[28px]'} width={210}
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Link href={'./'}><h3
                        className="text-heading-sm text-blue-300 max-h-[50px] overflow-hidden">{data.attributes.title}</h3>
                    </Link>
...

                {
                    data.attributes.total && data.attributes.sold ?
                        <>
                            ...
                            <div
                                className="mt-2.5 font-lato text-blue-300 text-xsmall">Sold: {data.attributes.sold}/{data.attributes.total}</div>
